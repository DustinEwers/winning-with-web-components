export class CounterCard {
    ...
    render() {
        return (h("div", { class: 'card' },
            h("h5", { class: 'card-header' }, "Counter"),
    ...
    static get properties() { return { "currentCount": { "state": true } }; }
    static get events() { return [{ "name": "countChanged", "method": "countChanged", "bubbles": true, "cancelable": true, "composed": true }]; }
